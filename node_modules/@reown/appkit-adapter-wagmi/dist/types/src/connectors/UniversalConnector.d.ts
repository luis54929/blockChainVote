...
export declare function walletConnect(parameters: AppKitOptionsParams, appKit: AppKit, caipNetworks: [CaipNetwork, ...CaipNetwork[]]): import("@wagmi/core").CreateConnectorFn<import("@walletconnect/universal-provider").default, {
    connect(parameters?: {
        chainId?: number;
        pairingTopic?: string;
    }): Promise<{
